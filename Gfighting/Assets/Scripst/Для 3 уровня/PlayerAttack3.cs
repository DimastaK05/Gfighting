...
public class PlayerAttack3 : MonoBehaviour
{
    ...
    IEnumerator Attack()
    {
        ...
        {
           enemy.GetComponent<Enemy3>().TakeDamage3(attackDamge);
        ...
        {
            enemy.GetComponent<Boss3>().TakeDamage3(attackDamge);
        }
    ...
    IEnumerator AttackCross()
    {
        ...
        foreach (Collider enemy in hitEnemies)
        {
            enemy.GetComponent<Enemy3>().TakeDamage3(attackCrossDamage);
      
        }
          Collider[] hitBoss = Physics.OverlapSphere(attackPoint.position, attackRange, bossLayer);
        foreach (Collider enemy in hitBoss)
        {
            enemy.GetComponent<Boss3>().TakeDamage3(attackCrossDamage);
        }
