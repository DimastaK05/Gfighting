...
public class PlayerAttack : MonoBehaviour
{
    ...
    public float attackAnimationDuration = 1f; // Добавлено: длительность анимации
    public float crossAttackAnimationDuration = 1.667f; // Добавлено: длительность кросс-атаки
